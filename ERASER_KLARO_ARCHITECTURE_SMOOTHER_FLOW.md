# Klaro — Compact Right-Flow Eraser Diagram

Use this exact block in Eraser and keep `Clients` pinned at the **top-left** (or middle-left) so users can follow the journey left → right.
...
tRPC Gateway > Rate Limiter: throttle
...
Worker Queue > Background Jobs: dispatch
