        ...
        <div className={styles.errorBlock__content}>
          ...
          <div className={styles.errorBlock__message}>
            <p className={styles.errorBlock__copy}>
              We encountered an unexpected error on our servers. This is not
              your fault – our team is already working to fix it.
            </p>
            <p className={styles.errorBlock__subcopy}>
              Your health information and account data are safe and secure. In
              the meantime, you can try refreshing the page or return to the
              dashboard.
            </p>
          </div>
          ...
          <div className={styles.errorBlock__actions}>
            <Button onClick={reset} className={styles.errorBlock__button}>
              Try Again
            </Button>
            <Link href="/dashboard" className={styles.errorBlock__link}>
              <Button
                variant="secondary"
                className={styles.errorBlock__buttonSecondary}
              >
                Back to Dashboard
              </Button>
            </Link>
          ...
          <div className={styles.errorBlock__suggestions}>
            <p className={styles.errorBlock__suggestionLabel}>
              Troubleshooting:
            </p>
        ...
        <div className={styles.errorBlock__sidebar}>
          <div className={styles.errorBlock__sidebarCard}>
            ...
            <p className={styles.errorBlock__sidebarText}>
              Our servers experienced a temporary issue while processing your
              request. This is automatically logged and will be investigated by
              our engineering team.
            </p>
          </div>

          <div className={styles.errorBlock__sidebarCard}>
            <h3 className={styles.errorBlock__sidebarTitle}>
              Need Immediate Help?
            </h3>
            <p className={styles.errorBlock__sidebarText}>
              If this error persists, please contact our support team. We're
              available to help.
            </p>
          ...
          <div className={styles.errorBlock__sidebarCard}>
            ...
            <p className={styles.errorBlock__sidebarText}>
              Your personal health information is encrypted and stored safely.
              This error will not affect your data.
            </p>
          </div>
        </div>
      </div>
