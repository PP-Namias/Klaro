        ...
        <header className={styles.forgot__header}>
          <div className={styles.forgot__brand}>
            ...
            <div className={styles.forgot__brandText}>
              ...
              <span className={styles.forgot__brandTag}>
          ...
          <Button
            ...
            size="lg"
            variant="outline"
            className={styles.forgot__ghostAction}
          >
        ...
        <section className={styles.forgot__hero}>
          <div className={styles.forgot__column}>
            <div className="space-y-6">
              ...
              <h1 className={styles.forgot__title}>
                Recover your Klaro account.
              </h1>
              <p className={styles.forgot__lede}>
                Enter the email address associated with your account and we'll
                send you a secure link to reset your password. You should
                receive the link within a few minutes.
              </p>
            </div>
            ...
            <div className={styles.forgot__form}>
              ...
              <div className={styles.forgot__footer}>
                <span className={styles.forgot__footerText}>
                  Remember your password?
                </span>
                <Button
                  asChild
                  variant="link"
                  className={styles.forgot__footerLink}
                >
          ...
          <aside className={styles.forgot__info}>
            <div className={styles.forgot__infoHeader}>
              <span className={styles.forgot__infoTitle}>
                What happens next
              </span>
            </div>
            ...
            <article className={styles.forgot__step}>
              ...
              <p className={styles.forgot__stepCopy}>
                We'll send a secure link to your inbox. This link works for one
                hour, then expires for security.
              </p>
            </article>
            ...
            <article className={styles.forgot__step}>
              ...
              <p className={styles.forgot__stepCopy}>
                Open the email and click the reset password link. If you don't
            ...
            <article className={styles.forgot__step}>
              ...
              <h3 className={styles.forgot__stepTitle}>
                Create a new password
              </h3>
              <p className={styles.forgot__stepCopy}>
                Choose a strong password at least 8 characters long. Make it
                unique to keep your medical data secure.
              </p>
            </article>

            <div className={styles.forgot__security}>
              <span className={styles.forgot__securityLabel}>
                Security note
              </span>
              <p className={styles.forgot__securityCopy}>
                Klaro never asks for your password via email. If you receive a
                suspicious email, please report it immediately.
              </p>
            </div>
          </aside>
        </section>
