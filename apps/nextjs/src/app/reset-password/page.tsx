        ...
        <header className={styles.reset__header}>
          <div className={styles.reset__brand}>
            ...
            <div className={styles.reset__brandText}>
              ...
              <span className={styles.reset__brandTag}>Healthcare for Filipinos</span>
            </div>
          </div>

          <Button asChild size="lg" variant="outline" className={styles.reset__ghostAction}>
          ...
          <div className={styles.reset__column}>
            <div className="space-y-6">
              ...
              <p className={styles.reset__lede}>
                Choose a strong password that you haven't used before. Your password should be
                at least 8 characters and include numbers and uppercase letters.
              </p>
            </div>
            ...
            <div className={styles.reset__form}>
              <div className={styles.reset__field}>
                ...
                <div className={styles.reset__strength}>
                  ...
                  <span className={styles.reset__strengthLabel}>Strong password required</span>
                </div>
              </div>
              ...
              <div className={styles.reset__checklist}>
                <div className={styles.reset__checkItem}>
                  ...
                  <span className={styles.reset__checkText}>At least 8 characters</span>
                </div>
                <div className={styles.reset__checkItem}>
                  <span className={styles.reset__checkIcon}>N</span>
                  <span className={styles.reset__checkText}>One number (0-9)</span>
                </div>
                <div className={styles.reset__checkItem}>
                  <span className={styles.reset__checkIcon}>U</span>
                  <span className={styles.reset__checkText}>One uppercase letter (A-Z)</span>
                </div>
              </div>
              ...
              <div className={styles.reset__footer}>
                <span className={styles.reset__footerText}>Already set a new password?</span>
                <Button asChild variant="link" className={styles.reset__footerLink}>
          ...
          <aside className={styles.reset__tips}>
            ...
            <article className={styles.reset__tip}>
              ...
              <p className={styles.reset__tipCopy}>
                Avoid passwords used on other websites. Use a password manager if you need help
                remembering.
              </p>
            </article>
            ...
            <article className={styles.reset__tip}>
              ...
              <p className={styles.reset__tipCopy}>
                Klaro support staff will never ask for your password. Keep it private and secure.
              </p>
            </article>
            ...
            <article className={styles.reset__tip}>
              ...
              <p className={styles.reset__tipCopy}>
                Change your password every few months to keep your medical data protected.
              </p>
            </article>

            <div className={styles.reset__security}>
              <span className={styles.reset__securityLabel}>Your security matters</span>
              <p className={styles.reset__securityCopy}>
                Klaro uses industry-standard encryption to protect your medical documents
