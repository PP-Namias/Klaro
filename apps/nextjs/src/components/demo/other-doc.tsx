      ...
      <div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
          {d.extractedFields.map((field, i) => (
            ...
            >
              <span style={{ fontSize: "0.85rem", color: "#6b7280", fontWeight: 500 }}>{field.key}</span>
              <span style={{ fontSize: "0.85rem", color: "#111827", fontWeight: 500, textAlign: "right", maxWidth: "60%" }}>
                {field.value}
              </span>
            </div>
          ))}
...
const urgencyBadgeStyle = (urgency: string): React.CSSProperties => ({
  ...
  borderRadius: 8, fontFamily: "var(--font-geist)", fontSize: "0.85rem",
  color: "#ffffff", fontWeight: 600,
  background: urgency === "HIGH" ? "#dc2626" : urgency === "MODERATE" ? "#d97706" : "#16a34a",
});
