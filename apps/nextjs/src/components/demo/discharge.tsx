    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <div style={diagnosisStyle}>
        <h4 style={sectionTitleStyle}>
          {language === "tl" ? "Diagnosis" : "Diagnosis"}
        </h4>
      ...
      <div>
        <h4 style={sectionTitleStyle}>
          {language === "tl" ? "Procedures" : "Procedures"}
        </h4>
        ...
        >
          {d.dischargeMedications.map((med, i) => (
            <div key={i} style={medCardStyle}>
              ...
              >
                <span
                  style={{ fontWeight: 600, color: "#111", fontSize: "0.9rem" }}
                >
                  {med.name}
                </span>
              ...
              >
                <span style={{ color: "#6b7280" }}>
                  Frequency:{" "}
                  <strong style={{ color: "#374151" }}>{med.frequency}</strong>
                </span>
                <span style={{ color: "#6b7280" }}>
                  Duration:{" "}
                  <strong style={{ color: "#374151" }}>{med.duration}</strong>
                </span>
              </div>
            </div>
          ))}
      ...
      <div style={followUpStyle}>
        <h4 style={{ ...sectionTitleStyle, color: "#166534", marginBottom: 8 }}>
          {language === "tl"
            ? "Follow-up Instructions"
            : "Follow-up Instructions"}
        </h4>
        {d.followUpInstructions.map((f, i) => (
          <div key={i} style={{ display: "flex", gap: 8, marginBottom: 6 }}>
            ...
            <span
              style={{ fontSize: "0.85rem", color: "#14532d", lineHeight: 1.4 }}
            >
              {f}
            </span>
          </div>
